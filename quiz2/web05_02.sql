...
CREATE TABLE `b_quiz_2_log` (
  `id` int(11) NOT NULL,
  `news` int(64) NOT NULL,
  `user` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- 傾印資料表的資料 `b_quiz_2_log`
--

INSERT INTO `b_quiz_2_log` (`id`, `news`, `user`) VALUES
(0, 8, 'mem01'),
(0, 6, 'mem01'),
(0, 2, 'admin');
...
CREATE TABLE `b_quiz_2_que` (
  `id` int(11) UNSIGNED NOT NULL,
  `text` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `count` int(11) UNSIGNED NOT NULL,
  `queid` int(11) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- 傾印資料表的資料 `b_quiz_2_que`
--

INSERT INTO `b_quiz_2_que` (`id`, `text`, `count`, `queid`) VALUES
...
(6, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 1, 0),
...
--
-- 資料表結構 `b_quiz_2_total`
--

CREATE TABLE `b_quiz_2_total` (
  `id` int(11) UNSIGNED NOT NULL,
  `date` date NOT NULL,
...
--
-- 傾印資料表的資料 `b_quiz_2_total`
--

INSERT INTO `b_quiz_2_total` (`id`, `date`, `total`) VALUES
(1, '2022-07-27', 10),
(2, '2022-07-28', 125),
(3, '2022-07-29', 4),
(4, '2022-08-01', 1000),
...
--
-- 傾印資料表的資料 `b_quiz_2_user`
--

INSERT INTO `b_quiz_2_user` (`id`, `acc`, `pw`, `email`) VALUES
...
-- 資料表索引 `b_quiz_2_news`
--
ALTER TABLE `b_quiz_2_news`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `b_quiz_2_que`
--
ALTER TABLE `b_quiz_2_que`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `b_quiz_2_total`
--
ALTER TABLE `b_quiz_2_total`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `b_quiz_2_user`
--
ALTER TABLE `b_quiz_2_user`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `b_quiz_2_news`
--
ALTER TABLE `b_quiz_2_news`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `b_quiz_2_que`
--
ALTER TABLE `b_quiz_2_que`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `b_quiz_2_total`
--
ALTER TABLE `b_quiz_2_total`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `b_quiz_2_user`
--
ALTER TABLE `b_quiz_2_user`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
