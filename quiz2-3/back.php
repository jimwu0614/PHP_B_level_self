...
<body>
    ...
    <div id="all">
        <div id="title">
            <?=date("m月d日l")?> | 今日瀏覽: <?=$Total->find(['date'=>$today])['total']?> | 累積瀏覽: <?=$Total->math("sum",'total')?> </div>
        <div id="title2">
            ...
            <div class="hal" id="main">
                <div>
                    ...
                    if (isset($_SESSION['user']) && $_SESSION['user']=="admin") {
                        echo "<span>歡迎，{$_SESSION['user']}</span><br><a href='./back.php'><button>管理</button></a>|<a href='./api/logout.php'><button>登出</button></a> ";
                    } else if (isset($_SESSION['user'])) {
                        echo "<span>歡迎，{$_SESSION['user']}</span><a href='./api/logout.php'><button>登出</button></a> ";
                    }else{
