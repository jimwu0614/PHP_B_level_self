			...
			<div class="hal" id="main">
				<div>
					...
					<div style="width:18%; display:inline-block;  ">
							...
							歡迎，admin<br><button style="display: inline;" onclick="location.href='?do=main'">管理</button>|<button style="display: inline;" onclick="location.href='./api/logout.php'">登出</button>
